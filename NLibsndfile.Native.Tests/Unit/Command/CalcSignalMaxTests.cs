...
namespace NLibsndfile.Native.Tests
{
    ...
    public class CalcSignalMaxTests
    {
        ...
        public void CalcSignalMax_ShouldThrowExceptionOnNegativeResult()
        {
            ...
            marshallerMock.Setup(x => x.AllocateDouble()).Returns(It.IsAny<IntPtr>());
        ...
        public void CalcSignalMax_ShouldPassOnZeroResult()
        {
            ...
            var marshallerMock = new Mock<ILibsndfileCommandMarshaller>();
            marshallerMock.Setup(x => x.AllocateDouble()).Returns(memoryMock.Object);
            marshallerMock.Setup(x => x.MemoryHandleToDouble(It.IsAny<UnmanagedMemoryHandle>())).Returns(SignalMax);
